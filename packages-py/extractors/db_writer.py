...
A future TypeScript extractor uses packages-ts/orchestrator/src/dbWriter.ts,
which mirrors this file's semantics with a callback in place of the context
manager.
"""
