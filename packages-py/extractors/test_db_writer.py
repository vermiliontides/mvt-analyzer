...
MIGRATION = REPO_ROOT / "packages-py" / "db" / "migrations" / "0002_ingest_completion.sql"
...
TS_WRITER = REPO_ROOT / "packages-ts" / "orchestrator" / "src" / "dbWriter.ts"
...
def test_both_writers_emit_the_same_load_bearing_sql(statement):
    ...
    """
    py = (REPO_ROOT / "packages-py" / "extractors" / "db_writer.py").read_text()
